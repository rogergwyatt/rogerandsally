...
export default function Page() {
    const productList = [
        ...
        },
        {
            ...
            name: "Mixed Species Charcuterie Board",
          ...
          <div className = "flex-none">
            <div className="w-full center p-2 text-center mr-5">
                ...
                <div className={"text-3xl "+serif.className}>
                    Our charcuterie boards are 3/4 inches thick. They are double-sided so you can use them however you want. Available in smaller sizes, you can find the board that is just right for you or the gift you are giving. They all feature the Heritage Lock in a complimentary wood species. Laser engraving are optional and a great touch to add.
                </div>
